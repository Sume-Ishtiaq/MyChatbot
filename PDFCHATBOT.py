...
from langchain_community.vectorstores import FAISS    #\Facebook AI Similarity Search it used like vector storage? and finidng the vector?
...
if "memory" not in st.session_state:
    st.session_state.memory = ConversationBufferMemory(return_messages=True, output_key='answer')
